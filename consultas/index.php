...
<body>
    ...
    <div class="row" style="margin-top: 3rem;">
        <div class="col-12 text-center" style="font-weight: bold; font-size: 26px; margin-bottom: 3rem;">CONSULTAS DE ENCUESTAS GENERALES</div>
    </div>
    ...
    <div class="row ml-3 mr-3">
        ...
        <div class="col-3 form-group form-check">
            <label for="consultaporsede" style="color:black; font-weight: bold;">Consultas por Proyectos</label>
...
<script type="text/javascript">
    ...
    function filtrar1(){
        ...
        $.ajax({
            type: 'POST',
            url: '../script/crud_consultas1.php',
            dataType: "JSON",
            data: {
                "pagina": pagina,
