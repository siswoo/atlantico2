...
if($condicion=='table1'){
	...
	*/
	...
	$sql1 = "SELECT * FROM proyectos WHERE id != 0 
		".$filtrado." 
		".$sede."
	";
	
	$sql2 = "SELECT * FROM proyectos WHERE id != 0 
		".$filtrado." 
		".$sede."
			...
			$html .= '
		                <tr id="tr_'.$row2["id"].'">
		                    ...
		                    <td class="text-center" nowrap="nowrap">
		                    	<button class="btn btn-danger" onclick="eliminar1('.$row2["id"].');">Eliminar</button>
		                    </td>
		                </tr>
			';
		}
...
if($condicion=="agregar1"){
	...
	$sql1 = "SELECT * FROM proyectos WHERE nombre = '$nombre'";
	$proceso1 = mysqli_query($conexion,$sql1);
	...
	if($contador1>=1){
		$datos = [
			"estatus"	=> "error",
			"sql1" 		=> $sql1,
			"msg"		=> "Municipio ya existente!",
		];
		echo json_encode($datos);
	}else{
		$sql2 = "INSERT INTO proyectos (nombre) VALUES ('$nombre')";
		$proceso2 = mysqli_query($conexion,$sql2);
		$datos = [
			"estatus"	=> "ok",
			"sql1" 		=> $sql1,
...
if($condicion=="eliminar1"){
	...
	$sql1 = "DELETE FROM proyectos WHERE id = ".$id;
	$proceso1 = mysqli_query($conexion,$sql1);
