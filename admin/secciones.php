                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12 form-group form-check">
                                <label for="nuevo_titulo" style="font-weight: bold;">Titulo (Opcional)</label>
                                <input type="text" name="nuevo_titulo" id="nuevo_titulo" autocomplete="off" class="form-control">
                            </div>
                            <div class="col-12 form-group form-check">
                                <label for="nuevo_tabla" style="font-weight: bold;">Tabla</label>
                                <select class="form-control" id="nuevo_tabla" name="nuevo_tabla" required>
                            ...
                            <div class="col-12 form-group form-check">
                                <label for="nuevo_proyecto" style="font-weight: bold;">Proyecto</label>
                                <select class="form-control" id="nuevo_proyecto" name="nuevo_proyecto" required>
                                    <option value="">Seleccione</option>
                                    <?php
                                    $sql9 = "SELECT * FROM proyectos";
                                    $proceso9 = mysqli_query($conexion,$sql9);
...
<script type="text/javascript">
    ...
    $("#nuevo_form").on("submit", function(e){
        ...
        var nuevo_tabla = $('#nuevo_tabla').val();
        var nuevo_proyecto = $('#nuevo_proyecto').val();
        var nuevo_orden = $('#nuevo_orden').val();
