                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12 form-group form-check">
                                <label for="nuevo_municipio" style="font-weight: bold;">Municipio</label>
                                <select class="form-control" name="nuevo_municipio" id="nuevo_municipio" required>
                                    <option value="">Seleccione</option>
                                    <?php
                                    $sql19 = "SELECT * FROM municipios";
                                    $proceso19 = mysqli_query($conexion,$sql19);
                                    while($row19 = mysqli_fetch_array($proceso19)) {
                                        echo '
                                            <option value="'.$row19["id"].'">'.$row19["nombre"].'</option>
                                        ';          
                                    }
                                    ?>
                                </select>
                            ...
                            <div class="col-12 form-group form-check">
                                <label for="nuevo_proyectos" style="font-weight: bold;">Proyectos</label>
                                <select class="form-control" name="nuevo_proyectos" id="nuevo_proyectos" required>
                                    <option value="">Seleccione</option>
                                    <?php
                                    $sql20 = "SELECT * FROM proyectos";
                                    $proceso20 = mysqli_query($conexion,$sql20);
                                    while($row20 = mysqli_fetch_array($proceso20)) {
                                        echo '
                                            <option value="'.$row20["id"].'">'.$row20["nombre"].'</option>
                                        ';          
                                    }
                                    ?>
                                </select>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12 form-group form-check">
                                <label for="editar_municipio" style="font-weight: bold;">Municipio</label>
                                <select class="form-control" name="editar_municipio" id="editar_municipio" required>
                                    <option value="">Seleccione</option>
                                    <?php
                                    $sql19 = "SELECT * FROM municipios";
                                    $proceso19 = mysqli_query($conexion,$sql19);
                            ...
                            <div class="col-12 form-group form-check">
                                <label for="editar_proyectos" style="font-weight: bold;">Proyectos</label>
                                <select class="form-control" name="editar_proyectos" id="editar_proyectos" required>
                                    <option value="">Seleccione</option>
                                    <?php
                                    $sql20 = "SELECT * FROM proyectos";
                                    $proceso20 = mysqli_query($conexion,$sql20);
...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                if(respuesta["estatus"]=="ok"){
                    ...
                    $('#editar_municipio').val(respuesta["municipio"]);
                    $('#editar_estatus').val(respuesta["estatus2"]);
                    $('#editar_proyectos').val(respuesta["proyectos"]);
                }else if(respuesta["estatus"]=="error"){
                    Swal.fire({
                        title: 'Error',
                        text: respuesta["msg"],
    ...
    $("#editar_form").on("submit", function(e){
        ...
        var municipio = $('#editar_municipio').val();
        var estatus = $('#editar_estatus').val();
        var proyectos = $('#editar_proyectos').val();
